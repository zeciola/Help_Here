...
<html>
    <head>
        ...
        <title>Bem vindo a HelpHere!</title>
                ...
                <div class="col-lg-6">
                    <a href="#">
                        <%
                            ...
                            if (usuario != null) {
                        %>
                        <h1 class="tagline" style="color: #0f7864">Bem vindo <%= usuario.getPe().getNome()%> <%= usuario.getPe().getSobrenome()%></h1>

                        <%}%>

                        <div style="margin-left: 50%">
                            <object type="image/svg+xml" data="../img/user.svg" width="250" height="250"></object>
