<%-- 
    ...
    Created on : 28/03/2017, 21:45:37
    Author     : Lucas Puglia
--%>
...
<html lang="pt-br">
    ...
    <head>
        <title>Cadastro de Instituição - Help Here</title>
        <meta charset="UTF-8">
    ...
    <div class="container">
        ...
        <form class="well form-horizontal" action="ControleInstituicao" method="post" id="contact_form">
            <fieldset>
                ...
                <legend class="titulo"><b>Cadastro de Instituição</b></legend>
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-4 inputGroupContainer">
                        <div class="input-group">
                            ...
                            <input name="nome" placeholder="Instituição" class="form-control" type="text">
                        </div>
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-4 selectContainer">
                        <div class="input-group">
                            <span class="input-group-addon"><i class="glyphicon glyphicon-user"></i></span>
                            <input name="cnpj" placeholder="CNPJ" class="form-control" type="number">
                        </div>
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-4 inputGroupContainer">
                        <div class="input-group">
                            <span class="input-group-addon"><i class="glyphicon glyphicon-user"></i></span>
                            <input name="modalidade" placeholder="Modalidade" class="form-control" type="text">
                        </div>
                    </div>
                </div>
