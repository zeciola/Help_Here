                            ...
                            <div class="content-box-large">
                                ...
                                <div class="panel-body">
                                    <table cellpadding="0" cellspacing="0" border="0" class="table table-striped table-bordered" id="example">
                                        ...
                                        <tbody>
                                            <% ArrayList<Endereco> ListaEnd = (ArrayList<Endereco>) request.getAttribute("endereco");
                                                if (ListaEnd == null) {
                                                    request.getRequestDispatcher("/ControleAdmin?acao=Listartable&url=tablend").forward(request, response);
                                                }%>
                                            <%for (Endereco e : ListaEnd) {%>  
                                            <tr class="odd gradeX">
                                                <td><%=e.getCep()%></td>
                                                <td><%=e.getNomelogradouro()%></td>
                                                <td><%=e.getNumeroen()%></td>
                                                <td><%=e.getBairro()%></td>
