                            ...
                            <div class="content-box-large">
                                ...
                                <div class="panel-body">
                                    <table cellpadding="0" cellspacing="0" border="0" class="table table-striped table-bordered" id="example">
                                        ...
                                        <tbody>
                                            <% ArrayList<Login> Lista = (ArrayList<Login>) request.getAttribute("usuario");
                                                if (Lista == null) {
                                                    request.getRequestDispatcher("/ControleAdmin?acao=Listartable&url=tableUser").forward(request, response);
                                                }%>
                                            <%for (Login e : Lista) {%>  
                                            <tr class="odd gradeX">
                                                <td><input type="checkbox" value="<%=e.getId()%>"></td>
                                                <td><%=e.getId()%></td>
                                                <td><%=e.getPe().getId()%></td>
                                                <td><%=e.getNome()%></td>
                                                <td><%=e.isStatus()%></td>
