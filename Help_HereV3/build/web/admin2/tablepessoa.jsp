                ...
                <div class="col-md-10">
                    <div class="row">
                        <div class="content-box-large">
                            ...
                            <div class="content-box-large">
                                <div class="panel-heading">
                                    <div class="panel-title">Pessoa</div>
                                </div>
                                <div class="panel-body">
                                    <table cellpadding="0" cellspacing="0" border="0" class="table table-striped table-bordered" id="example">
                                        ...
                                        <tbody>
                                            <% ArrayList<Pessoa> ListaPessoa = (ArrayList<Pessoa>) request.getAttribute("pessoa");
                                                if (ListaPessoa == null) {
                                                    request.getRequestDispatcher("/ControleAdmin?acao=Listartable&url=tablepessoa").forward(request, response);
                                                }%>
